...
export function SettingsPage({ colors, onNew }: SettingsPageProps) {
  return (
    <ScrollView contentContainerStyle={styles.content}>
      <Text style={styles.eyebrow}>FIELDOPS</Text>
      <Text style={[styles.title, { color: colors.text }]}>Configurações</Text>
      <Text style={[styles.subtitle, { color: colors.muted }]}>
        Preferências e configurações do ambiente.
      </Text>
      ...
      >
        ...
        <Text style={[styles.panelTitle, { color: colors.text }]}>Configurações gerais</Text>
